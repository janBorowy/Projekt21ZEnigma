...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CipherTextBrowser.setFont(font2)
        ...
        self.PlainTextBrowser.setFont(font2)

        self.horizontalLayout.addWidget(self.PlainTextBrowser)


        self.gridLayout_5.addLayout(self.horizontalLayout, 3, 0, 2, 6)
        ...
        self.rotor_B_regress.setFont(font4)
        ...
        self.rotor_A_display.setFont(font5)
        ...
        self.rotor_A_regress.setFont(font4)
        ...
        self.rotor_C_regress.setFont(font4)
        ...
        self.rotor_C_display.setFont(font5)
        ...
        sizePolicy2.setHeightForWidth(self.rotor_A_advance.sizePolicy().hasHeightForWidth())
        self.rotor_A_advance.setSizePolicy(sizePolicy2)
        ...
        self.rotor_B_display.setFont(font5)
        ...
        sizePolicy3.setHeightForWidth(self.ring_setting_C.sizePolicy().hasHeightForWidth())
        self.ring_setting_C.setSizePolicy(sizePolicy3)

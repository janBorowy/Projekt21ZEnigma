...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_5.addWidget(self.reset_button, 2, 3, 1, 1)
        ...
        self.rotor_B_display.setMinimumSize(QSize(50, 0))
        font = QFont()
        font.setPointSize(48)
        self.rotor_B_display.setFont(font)
        self.rotor_B_display.setAlignment(Qt.AlignCenter)

        self.gridLayout_3.addWidget(self.rotor_B_display, 0, 4, 2, 1)
        ...
        sizePolicy.setHeightForWidth(self.rotor_A_advance.sizePolicy().hasHeightForWidth())
        self.rotor_A_advance.setSizePolicy(sizePolicy)
        self.rotor_A_advance.setMaximumSize(QSize(20, 16777215))

        self.gridLayout_3.addWidget(self.rotor_A_advance, 0, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.rotor_B_regress, 1, 5, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.rotor_C_regress, 1, 2, 1, 1)
        ...
        self.rotor_A_display.setMinimumSize(QSize(50, 0))
        self.rotor_A_display.setFont(font)
        self.rotor_A_display.setAlignment(Qt.AlignCenter)

        self.gridLayout_3.addWidget(self.rotor_A_display, 0, 7, 2, 1)
        ...
        self.gridLayout_3.addWidget(self.rotor_A_regress, 1, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.rotor_B_advance, 0, 5, 1, 1)
        ...
        self.rotor_C_display.setMinimumSize(QSize(50, 0))
        self.rotor_C_display.setFont(font)
        self.rotor_C_display.setAlignment(Qt.AlignCenter)

        self.gridLayout_3.addWidget(self.rotor_C_display, 0, 1, 2, 1)

        self.horizontalSpacer_4 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_3.addItem(self.horizontalSpacer_4, 0, 9, 1, 1)


        self.gridLayout_5.addLayout(self.gridLayout_3, 1, 0, 1, 4)
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout, 3, 0, 2, 4)

        self.clear_button = QPushButton(self.centralwidget)
        self.clear_button.setObjectName(u"clear_button")

        self.gridLayout_5.addWidget(self.clear_button, 2, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.config_box, 2, 4, 2, 2)

        self.verticalSpacer_2 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Minimum)

        self.gridLayout_5.addItem(self.verticalSpacer_2, 4, 4, 1, 2)
        ...
        sizePolicy2.setHeightForWidth(self.button_Q.sizePolicy().hasHeightForWidth())
        self.button_Q.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.button_P.sizePolicy().hasHeightForWidth())
        self.button_P.setSizePolicy(sizePolicy2)
